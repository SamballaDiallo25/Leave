                            ...
                            <table id="example" class="table table-striped nowrap" style="width:100%">
                                ...
                                if ($stmt->num_rows > 0) {
                                    while ($stmt->fetch()) {
                                        ...
                                        echo '<a href="../Form_1/delete.php?table=faculties1&id=' . htmlspecialchars($faculty_id) . '" class="btn btn-dark custom-btn text-light" onclick="return confirm(\'' . __('Are you sure you want to delete this user?') . '\')"><i class="fa-solid fa-trash"></i></a>';
                                        echo '</td>';
                                        echo "</tr>";
                                    }
                                } else {
